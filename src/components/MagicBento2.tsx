...
const cardData: BentoCardProps[] = [
  { color: '#060010', title: 'Health tools', description: 'for everyone', label: 'Smart' },
  { color: '#060010', title: 'Medical info', description: 'at hand', label: 'Trusted' },
  { color: '#060010', title: 'Care networks', description: 'made simple', label: 'Connected' },
  { color: '#060010', title: 'Health guidance', description: 'in Kurdistan', label: 'Digital' },
  { color: '#060010', title: 'Reliable tips', description: 'everywhere', label: 'Accessible' },
  { color: '#060010', title: 'Patient decisions', description: 'with ease', label: 'Empowered' },
];
...
const MagicBento2: React.FC<BentoProps> = ({
  textAutoHide = true,
  enableStars = true,
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          const cardProps = { className: baseClassName, style: { backgroundColor: card.color, '--glow-color': glowColor } as React.CSSProperties };
          if (enableStars) {
            return (
